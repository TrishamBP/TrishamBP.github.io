...
<section class="hero">
  ...
  <div class="hero-content">
    ...
    <div class="social-links" aria-label="Social links">
      <a
        class="social-link"
        href="https://github.com/TrishamBP"
        target="_blank"
      ...
      <a
        class="social-link"
        href="https://www.linkedin.com/in/trishampatil/"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="LinkedIn"
      >
        <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
          <path
            d="M20.45 20.45h-3.55v-5.57c0-1.33-.03-3.05-1.86-3.05-1.87 0-2.16 1.45-2.16 2.95v5.67H9.33V9h3.4v1.56h.05c.47-.9 1.64-1.86 3.38-1.86 3.61 0 4.28 2.37 4.28 5.46v6.29ZM5.34 7.43a2.06 2.06 0 1 1 0-4.12 2.06 2.06 0 0 1 0 4.12ZM7.12 20.45H3.56V9h3.56v11.45ZM22.23 0H1.77A1.77 1.77 0 0 0 0 1.77v20.46C0 23.2.8 24 1.77 24h20.46c.98 0 1.77-.8 1.77-1.77V1.77C24 .8 23.2 0 22.23 0Z"
          ></path>
        </svg>
      </a>
      <a
      ...
      >
        <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
          <path
            d="M2.5 4A2.5 2.5 0 0 0 0 6.5v11A2.5 2.5 0 0 0 2.5 20h19a2.5 2.5 0 0 0 2.5-2.5v-11A2.5 2.5 0 0 0 21.5 4h-19Zm0 2h19c.1 0 .2.04.28.1L12 12.88 2.22 6.1A.48.48 0 0 1 2.5 6Zm-1 1.83 8.96 6.2a2.5 2.5 0 0 0 2.88 0l8.96-6.2V17.5a.5.5 0 0 1-.5.5h-19a.5.5 0 0 1-.5-.5V7.83Z"
          ></path>
        </svg>
      </a>
    </div>
  ...
  <div class="timeline">
    <article class="timeline-item">
      <div class="timeline-left">
        ...
        <img
          class="timeline-logo"
          src="{{ '/images/universities/wpi.svg' | relative_url }}"
          alt="Worcester Polytechnic Institute logo"
        />
      </div>
      <div class="timeline-right">
        <h3>Master of Science in Mechanical Engineering</h3>
        <p class="timeline-university">Worcester Polytechnic Institute (USA)</p>
        <p>
          Specialized in thermofluids and computational fluid dynamics, with
          coursework and research centered on numerical simulation, fluid
          mechanics modeling, and scientific computing in Python.
        </p>
      </div>
    </article>
    ...
    <article class="timeline-item">
      <div class="timeline-left">
        <p class="timeline-year">2015 &mdash; 2019</p>
        <img
          class="timeline-logo"
          src="{{ '/images/universities/pune.svg' | relative_url }}"
          alt="University of Pune logo"
        />
      </div>
      <div class="timeline-right">
        <h3>Bachelor of Engineering in Mechanical Engineering</h3>
        <p class="timeline-university">University of Pune</p>
        <p>
          Final year project involved designing a fixed-wing drone capable of
          safe gliding during power loss, including aerodynamic wing design,
          airflow modeling, structural design, and stability analysis.
        </p>
      </div>
    </article>
  </div>
...
<section class="content-section work-section" aria-labelledby="work-experience-heading">
  ...
  <div class="timeline">
    <article class="timeline-item">
      <div class="timeline-left">
        <p class="timeline-year">2026 &mdash; Present</p>
        <img
          class="timeline-logo"
          src="{{ '/images/companies/cloudangles.svg' | relative_url }}"
          alt="CloudAngles logo"
        />
      </div>
      <div class="timeline-content">
        ...
        <p>
          ...
          workflows into agentic AI systems, and owning delivery end-to-end
    ...
    <article class="timeline-item">
      <div class="timeline-left">
        <p class="timeline-year">2023 &mdash; 2025</p>
        <img
          class="timeline-logo"
          src="{{ '/images/companies/gaius.svg' | relative_url }}"
          alt="Gaius Networks logo"
        />
      </div>
      <div class="timeline-content">
        <h3>Senior Software Engineer</h3>
        <p class="timeline-university">Gaius Networks (Flipped.ai / ParseTalent)</p>
        <p>
          Led development of an enterprise AI-powered recruitment automation
          platform.
        </p>
        <ul>
          <li>
            Designed and deployed RAG systems for CV parsing, job description
            analysis, and candidate matching.
          </li>
          <li>
            Built GPU-based LLM inference services with vLLM for scalable
            concurrent processing.
          </li>
          <li>
            Developed multilingual AI pipelines including Arabic OCR,
            translation, and structured extraction.
          </li>
          <li>
            Built distributed microservices using FastAPI, Redis, RabbitMQ,
            Docker, and Kubernetes.
          </li>
          <li>
            Integrated AI systems with ATS platforms including Zoho Recruit and
            Greenhouse.
          </li>
          <li>
            Designed backend infrastructure for large-scale document ingestion
            and real-time AI processing.
          </li>
          <li>
            Contributed to the platform that secured a multi-million dollar
    ...
    <article class="timeline-item">
      <div class="timeline-left">
        <p class="timeline-year">2022 &mdash; 2023</p>
        <img
          class="timeline-logo"
          src="{{ '/images/companies/techgigs.svg' | relative_url }}"
          alt="TechGigs LLP logo"
        />
      </div>
      <div class="timeline-content">
        <h3>Full Stack Developer</h3>
        <p class="timeline-university">TechGigs LLP</p>
        <p>
          Developed scalable web platforms and backend infrastructure for
          multiple production applications.
        </p>
        <ul>
          <li>
            Designed REST APIs with Node.js and Express.js for high-traffic
            production systems.
          </li>
          <li>
            Built backend services integrating MongoDB, PostgreSQL, and cloud
            storage systems.
          </li>
          <li>
          ...
          <li>
            Optimized infrastructure for high request volumes with improved
...
<section class="content-section articles-section" aria-labelledby="articles-heading">
  ...
  {% assign paged_posts = paginator.posts %}
  {% if paged_posts == nil %}
    {% assign paged_posts = site.posts | slice: 0, 5 %}
  {% endif %}
  ...
  {% if paginator and paginator.total_pages > 1 %}
    <nav class="article-pagination" aria-label="Articles pagination">
      ...
      {% for page_number in (1..paginator.total_pages) %}
        ...
        {% elsif page_number == 1 %}
          <a href="{{ '/' | relative_url }}">{{ page_number }}</a>
        {% else %}
          <a href="{{ site.paginate_path | relative_url | replace: ':num', page_number }}">{{ page_number }}</a>
        {% endif %}
      {% endfor %}
